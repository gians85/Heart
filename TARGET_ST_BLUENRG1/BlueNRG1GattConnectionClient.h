...
/**
  ...
  * @brief   Header file for BlueNRG1GattConnectionClient Class
  ******************************************************************************
  * @copy
  *
...
#ifndef __BLUENRG1GATTCONNECTIONCLIENT_H__
#define __BLUENRG1GATTCONNECTIONCLIENT_H__
...
class BlueNRG1GattConnectionClient
{
public:
    ...
    void charWriteExecCB(void);

//protected:

    BlueNRG1GattConnectionClient(BlueNRG1GattClient *gattClient, Gap::Handle_t connectionHandle):
                                discoveredService(),
                                discoveredChar(),
                                readCBParams(),
                                writeCBParams(),
     ...
     //PRINTF("BlueNRG1GattConnectionClient construtor: connHandle=%d\n\r", connectionHandle);
...
private:
  ...
  BlueNRG1GattConnectionClient(BlueNRG1GattConnectionClient const &);
  void operator=(BlueNRG1GattConnectionClient const &);
  ~BlueNRG1GattConnectionClient() {};

  BlueNRG1GattClient *_gattClient;

  Gap::Handle_t _connectionHandle;
  DiscoveredService discoveredService[BLE_TOTAL_DISCOVERED_SERVICES];
  BlueNRG1DiscoveredCharacteristic discoveredChar[BLE_TOTAL_DISCOVERED_CHARS];
