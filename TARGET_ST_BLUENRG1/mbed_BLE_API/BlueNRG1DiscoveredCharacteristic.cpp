...
void BlueNRG1DiscoveredCharacteristic::setup(BlueNRG1GattClient *gattcIn,
                                            ...
                                            GattAttribute::Handle_t  lastHandleIn)
{
 ...
 void BlueNRG1DiscoveredCharacteristic::setLastHandle(GattAttribute::Handle_t  lastHandleIn) {
     lastHandle = lastHandleIn;
 }
